...
movies.each do |title|
  ...
  youtube_response = open("https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&q=#{title}+trailer&key=#{ENV["YOUTUBE_TOKEN"]}").read
  print youtube_reponse
